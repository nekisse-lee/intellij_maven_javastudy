...
(/** @lends <global> */function( $ ) {
	...
	function _fnDraw( oSettings )
	{
		...
		{
			/* Table is empty - create a row with an empty message16 in it */
	...
	function _fnInitialise ( settings )
	{
		...
		// data (show 'loading' message16 possibly)
		_fnReDraw( settings );
	...
	/**
	 * Log an error message16
	 *  @param {object} settings dataTables settings object
	 *  @param {int} level log error messages, or display them to the user
	 *  @param {string} msg error message16
	...
	DataTable.defaults = {
		 ...
		 *           json[i][0] = '<a href="/message16/'+json[i][0]+'>View message16</a>';
		 *         }
		 *         return json;
		 *       }
		 *     }
		...
		"oLanguage": {
			 ...
			 * gathering the data, this message16 is shown in an empty row in the table to
